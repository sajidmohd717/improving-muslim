...
As of 16 July 2026, the catalog contains 12 series and 27 standalone lectures, with 105 lectures currently watchable on the platform. More episodes are uploaded progressively; the live [upload roadmap](https://improvingmuslim.com/pages/roadmap.html) shows the current schedule.
