...
For architecture, implementation order, validation, and handoff instructions,
read [DEV_README.md](./DEV_README.md). Product and visual decisions live in
...
Regenerate the project after changing `project.yml`. The generated `.xcodeproj`
and `ImprovingMuslim/Info.plist` are intentionally ignored by Git.
